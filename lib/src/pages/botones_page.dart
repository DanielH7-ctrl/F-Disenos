  ...
  Widget _botonesRedondeados() {
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.purpleAccent, Icons.shop, 'Buy' ),
        ...
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.redAccent, Icons.collections, 'Photos' ),
            _crearBotonRedondeado( Colors.yellow, Icons.help_outline, 'Complaints' ),
          ]
        ),
      ],
    );
